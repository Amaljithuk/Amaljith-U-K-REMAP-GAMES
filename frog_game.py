...
class GameEngine:
    ...
    def create_ui(self):
        ...
        # Game Over – buttons sit near bottom of the larger panel (panel_y=100, panel_h=490 → bottom at ~590)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    if self.state in (GameState.SETTINGS, GameState.INSTRUCTIONS, GameState.GAME_OVER):
